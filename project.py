    ...
    def run_process(self, p: Process) -> None:
        ...
        for i in range(p.burst_num):
            ...
            if p.cpu_bound:
                ...
                cpu_burst = 4*math.ceil(self.next_exp())
                if i != p.burst_num - 1:
                    io_burst = 10*math.ceil(self.next_exp())/4 
            else:      
